...
let s:palette.comment   = {'dark': "#87aab6",  'light': "#ABB0B6",  'mirage': "#87aab6"}
...
let s:palette.tag       = {'dark': "#36A3D9",  'light': "#36A3D9",  'mirage': "#87aab6"}
...
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#87aab6",  'mirage': "#D9D7CE"}
let s:palette.fg_idle   = {'dark': "#87aab6",  'light': "#828C99",  'mirage': "#607080"}
